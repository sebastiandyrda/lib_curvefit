...
! ------------------------------------------------------------------------------
    module subroutine ns_solve(this, fcn, x, fvec, ib, err)
        ...
        if (nvar /= neqn) then
            ...
            write(errmsg, '(A,I0,A,I0,A)') "The number of equations (", neqn, &
        ...
        if (flag /= 0) then
            ...
            write(errmsg, '(A,I0,A)') "Input number ", flag, &
        ...
        if (.not.fcnvrg) then
            ...
            do
                ...
                if (check) then
                    ...
                    write(errmsg, '(A,I0,A,E8.3,A,E8.3)') &
        ...
        if (flag /= 0) then
            write(errmsg, '(A,I0,A,E8.3,A,E8.3)') "The algorithm failed to " // &
