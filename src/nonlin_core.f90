...
! ------------------------------------------------------------------------------
    ...
    subroutine print_status(iter, nfeval, njaceval, xnorm, fnorm)
        ...
        print '(A,I0)', "Function Evaluations: ", nfeval
        if (njaceval > 0) print '(A,I0)', "Jacobian Evaluations: ", njaceval
        print '(A,E9.3)', "Change in Variable: ", xnorm
        print '(A,E9.3)', "Residual: ", fnorm
    end subroutine
end module
